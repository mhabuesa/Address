...
<head>
    ...
    <title>Under Construction Projects</title>
    <!-- FAVICON -->
        ...
        <section class="properties-list featured portfolio blog">
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p><a href="{{route('index')}}">Home </a> &nbsp;/&nbsp; <span>Under Construction </span></p>
                                </div>
                                <h3> Properties in Under Construction</h3>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div class="row">
                    ...
                    @foreach($under_cons as $property )
                        ...
                        <div class="project-single" data-aos="fade-up">
                            ...
                            <div class="homes-content">
                                ...
                                <p class="homes-address mb-3">
                                    ...
                                    <a href="{{route('single.property',$property->id)}}">
                                        <i class="fa-solid fa-location-dot"></i></i><span>{{$property->location}}</span>
                                    </a>
