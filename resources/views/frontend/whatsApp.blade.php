...
<div class="center">
    <img class="close-btn" width="65" id="show-login" src="{{asset('frontend')}}/assets/images/whatsapp.png" alt="">
</div>
<div class="popup ">
    ...
    <div class="form">
        <div class="card">
            ...
            <div class="Content" style="background: url({{asset('frontend')}}/assets/images/wa_bg.png)" >
                    <div class="text">
                        <div style="color: gray; font-size: 14px; font-weight: bold;">BD ADDRESS</div>
                    <div style="color: gray; font-size: 14px;"><p>Hey there! 😀 How can I help you?</p></div>
                    </div>
            </div>
