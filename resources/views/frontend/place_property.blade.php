                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p><a href="{{route('index')}}">Home </a> &nbsp;/&nbsp; <span>{{$partner->name}}</span></p>
                                </div>
                                <h3> Properties in {{$partner->name}}</h3>
                            </div>
                        </div>
                    </div>
                </section>
                            ...
                            <div class="tab-pane fade show active" id="tabs_1">
                                <div class="rld-main-search">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="rld-single-select mr-3 ">
                            ...
                            <div class="project-inner project-head">
                                <div class="homes">
                                    ...
                                    <a href="{{route('single.property',$property->id)}}" class="homes-img">
                                        ...
                                        <div class="homes-tag featured button alt sale text-capitalize">For {{$property->status}}</div>
                            ...
                            <div class="homes-content">
                                ...
                                <ul class="homes-list clearfix pb-3">
                                    ...
                                    <li class="the-icons">
                                        ...
                                        <span>{{$property->c_bath+$property->a_bath}} Bathrooms</span>
                                    </li>
                                    <li class="the-icons">
