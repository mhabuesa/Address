                ...
                <form action="{{route('upcoming.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-12">
                            ...
                            <div class=" col-lg-2 mt-3">
                                <label class="form-label">Attached Bath</label>
                                <select class="form-control" name="a_bath" >
                            ...
                            <div class=" col-lg-2 mt-3">
                                <label class="form-label">Common Bath</label>
                                <select class="form-control" name="c_bath" >
                                    <option value="">Select Bath</option>
                                    <option value="0">0</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
